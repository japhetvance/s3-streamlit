...
if my_page == 'About the data':
    ...
    if title:
        ...
        if article_sentiment.lower() == 'positive':
            color = 'green'
        elif article_sentiment.lower() == 'negative':
            color = 'red'
        else:
            color = 'gray'
        
        col1.markdown(f'This article is <span style="color: {color};">**{article_sentiment.upper()}**</span> based on the article content.', unsafe_allow_html=True)
